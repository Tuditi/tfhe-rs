...
/// a properly configured [`FftView`] object and a `PodStack` used as a memory buffer having a
/// capacity at least as large as the result of
/// [`crate::core_crypto::algorithms::programmable_bootstrap_lwe_ciphertext_mem_optimized_requirement`].
pub fn batched_programmable_bootstrap_lwe_ciphertext_mem_optimized<
    InputScalar,
    OutputScalar,
    InputCont,
    OutputCont,
